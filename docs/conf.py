...
# -*- coding: utf-8 -*-
"""
hydra_orion_sweeper documentation build configuration file.
...
src_path = os.path.abspath(os.path.join(docs_src_path, '..', 'hydra_plugins'))
sys.path.insert(0, src_path)
src_path = os.path.abspath(os.path.join(docs_src_path, '..'))
sys.path.insert(0, src_path)

import hydra_orion_sweeper  # noqa
...
project = u'Hydra Orion Sweeper'
_full_version = hydra_orion_sweeper.__version__
author = hydra_orion_sweeper.__author__
copyright = hydra_orion_sweeper.__copyright__
...
htmlhelp_basename = 'hydra_orion_sweeper-doc'
...
latex_documents = [
    (master_doc, 'hydra_orion_sweeper.tex', u'Hydra Orion Sweeper Documentation',
     u'authors', 'manual'),
]
...
man_pages = [
    (master_doc, 'Hydra Orion Sweeper', 'Hydra Orion Sweeper Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'hydra_orion_sweeper', 'Hydra Orion Sweeper Documentation',
     author, 'Hydra Orion Sweeper', hydra_orion_sweeper.__descr__,
     'Miscellaneous'),
]
